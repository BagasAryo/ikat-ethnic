...
@section('content')
              ...
              <td class="px-6 py-4 text-sm">
                ...
                <div class="sm:hidden flex justify-end relative dropdown-container">
                  ...
                  <div class="dropdown-menu hidden absolute right-0 top-full mt-1 w-32 bg-surface2 border border-black/10 rounded-sm shadow-lg z-50 overflow-hidden">
                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="flex items-center gap-2 px-4 py-2.5 text-xs text-ink hover:bg-black/5 transition-colors">
  ...
  @else
    <div class="bg-surface border border-black/10 rounded-sm p-16 text-center">
      <div class="w-16 h-16 bg-surface2 rounded-full flex items-center justify-center mx-auto mb-4 border border-black/10">
