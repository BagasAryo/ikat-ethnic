...
@section('content')
  <div class="mb-6 flex items-center justify-between gap-4">
    <div>
      ...
      <p class="text-sm text-faint mt-1">Kelola akun admin.</p>
    </div>
    <a href="{{ route('admin.admins.create') }}"
      class="inline-flex items-center justify-center gap-2 px-4 py-2 bg-gold text-bg text-sm font-medium rounded-sm hover:bg-gold/90 transition-colors">
