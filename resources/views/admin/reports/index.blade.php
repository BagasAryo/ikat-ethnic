...
@section('content')
  ...
  {{-- ── Filter Form ──────────────────────────────────────────────── --}}
  <div class="bg-surface border border-white/5 rounded-sm p-4 sm:p-5 mb-6">
    <form method="GET" action="{{ route('admin.reports.index') }}"
      ...
      <div class="flex items-end gap-3">
        <div class="flex flex-col gap-1.5 flex-1 sm:flex-none">
          ...
          <input type="date" id="date_from" name="date_from"
            ...
            class="bg-surface2 border border-white/10 rounded-sm text-ink text-xs px-3 py-2 outline-none w-full sm:w-auto
      ...
      {{-- Submit --}}
      <button type="submit"
        class="flex items-center justify-center gap-2 bg-gold text-bg text-xs font-semibold px-4 py-2.5 sm:py-2 rounded-sm
  ...
  <div class="grid grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 mb-6">
    ...
    <div class="bg-surface border border-white/5 rounded-sm p-4 sm:p-5 hover:border-gold/20 transition-colors duration-300">
  ...
  <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
    ...
    {{-- Status Breakdown --}}
    <div class="bg-surface border border-white/5 rounded-sm p-4 sm:p-6">
  ...
  @if ($topProducts->isNotEmpty())
    <div class="bg-surface border border-white/5 rounded-sm mb-6">
      <div class="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-white/5">
        <div>
