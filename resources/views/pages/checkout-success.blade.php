...
@section('title', 'Checkout Success | Ikat Ethnic')

@section('content')
  <!-- Success Main Card -->
  <main
    class="grow w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 relative z-20 flex items-center justify-center">
