...
<body class="bg-bg text-ink font-body antialiased selection:bg-gold selection:text-obsidian-900 flex flex-col min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="shrink-0 flex items-center gap-2 cursor-pointer">
                    <span class="font-body font-bold text-2xl tracking-wider text-gold uppercase">Tenun Gallery</span>
                </div>

                <!-- Desktop Menu -->
                <div class="hidden md:flex items-center space-x-12">
                    <a href="#" class="text-xs tracking-[0.15em] font-medium text-gold border-b border-gold pb-1 uppercase">Collections</a>
                    <a href="#" class="text-xs tracking-[0.15em] font-medium text-muted hover:text-gold-lt transition-colors uppercase">Artisans</a>
                    <a href="#" class="text-xs tracking-[0.15em] font-medium text-muted hover:text-gold-lt transition-colors uppercase">Heritage</a>
                </div>

                <!-- Icons & Auth -->
                <div class="flex items-center space-x-6">
                    <button class="text-ink hover:text-gold-lt transition-colors">
                        <i data-feather="search" class="w-5 h-5"></i>
                    </button>
                    <a href="#" class="text-ink hover:text-gold-lt transition-colors relative">
                    ...
                    @if (Route::has('login'))
                        <div class="hidden sm:flex items-center ml-4 pl-4 border-l border-surface2">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="text-xs tracking-wider text-ink hover:text-gold-lt uppercase transition-colors">Dashboard</a>
                            @else
                                <a href="{{ route('login') }}" class="text-xs tracking-wider text-ink hover:text-gold-lt uppercase transition-colors">Log in</a>
                            @endauth
                        </div>
                    @endif
    ...
    <header class="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-start justify-center pt-20">
            <div class="max-w-2xl">
                <p class="text-gold-lt text-xs sm:text-sm font-semibold tracking-[0.2em] uppercase mb-4 pl-1">The Sumba Collection</p>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#catalog" class="inline-flex items-center justify-center px-8 py-3.5 bg-gold hover:bg-gold-lt text-bg text-sm font-medium tracking-wide uppercase transition-all duration-300">
                        Explore Sumba
                    </a>
                    <a href="#" class="inline-flex items-center justify-center px-8 py-3.5 bg-transparent border border-gold/50 hover:border-gold-lt text-gold-lt text-sm font-medium tracking-wide uppercase transition-all duration-300">
                        View Gallery
                    </a>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between w-full">
                    ...
                    <div class="hidden lg:flex items-center gap-6">
                        ...
                        <div class="relative group">
                            <input type="text" placeholder="Search heritage..." class="w-64 bg-surface border border-surface2 focus:border-gold text-ink text-sm px-4 py-2.5 pl-10 rounded-sm outline-none transition-colors placeholder:text-muted">
                            <i data-feather="search" class="w-4 h-4 text-muted absolute left-3 top-1/2 transform -translate-y-1/2 group-focus-within:text-gold transition-colors"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
            ...
            <div class="group cursor-pointer">
                <div class="relative overflow-hidden bg-surface aspect-4/5 mb-5">
                    ...
                    <div class="absolute top-4 left-4 flex gap-2">
                        <span class="bg-bg/80 backdrop-blur-sm text-gold-lt text-[10px] font-bold tracking-[0.2em] uppercase px-3 py-1">Masterpiece</span>
                    </div>
                    <!-- Hover Action -->
            ...
            <div class="group cursor-pointer">
                <div class="relative overflow-hidden bg-surface aspect-4/5 mb-5">
                    ...
                    <div class="absolute top-4 left-4 flex gap-2">
                        <span class="bg-bg/80 backdrop-blur-sm text-gold-lt text-[10px] font-bold tracking-[0.2em] uppercase px-3 py-1">New Arrival</span>
                    </div>
                    <div class="absolute inset-x-0 bottom-0 p-4 opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                        <button class="w-full bg-gold hover:bg-gold-lt text-bg font-medium text-sm py-3 uppercase tracking-wider">Add to Bag</button>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="relative h-[400px] overflow-hidden group">
                    ...
                    <div class="absolute bottom-8 left-8 pr-8">
                        <span class="text-gold-lt text-xs font-semibold tracking-[0.2em] uppercase mb-2 block">Meet the Maker</span>
                        <h3 class="text-3xl text-white mb-3">Ibu Ratna: Guardian of Sumba</h3>
                        <p class="text-ink text-sm leading-relaxed max-w-md font-light">A third-generation master weaver preserving the sacred symbolism of Hinggi Kombu for over 40 years.</p>
                    </div>
                </div>
                <div class="flex flex-col items-center justify-center bg-gold-lt/5 h-[400px] p-12 text-center border border-gold/10">
                    <i data-feather="shield" class="text-gold w-8 h-8 mb-6"></i>
                    <h3 class="text-2xl text-gold-lt mb-4">Authenticity Guaranteed</h3>
                    <p class="text-muted text-sm leading-relaxed font-light mb-8 max-w-xs">Every piece comes with a signed certificate of origin and artisan profile.</p>
                    <a href="#" class="text-gold text-xs tracking-[0.15em] uppercase font-medium border-b border-gold/30 hover:border-gold pb-1 transition-colors">Learn Our Process</a>
                </div>
            </div>
        </div>
    </section>
