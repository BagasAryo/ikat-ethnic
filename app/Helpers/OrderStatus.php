...
{
    /**
     * Satu sumber kebenaran untuk warna & label status order.
     * Dipakai di semua tempat: dashboard, laporan, orders admin, orders customer.
     */
    public static function meta(string $status): array
    {
        ...
        return match (true) {
            in_array($st, ['completed', 'selesai']) => [
                'label' => 'Selesai',
                'fill'    => 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20',
            ...
            in_array($st, ['processing', 'diproses']) => [
                'label' => 'Diproses',
                'fill'    => 'bg-gold/10 text-gold border-gold/20',
            ...
            $st === 'shipped' => [
                'label' => 'Dikirim',
                'fill'    => 'bg-blue-500/10 text-blue-600 border-blue-500/20',
            ...
            in_array($st, ['cancelled', 'dibatalkan']) => [
                'label' => 'Dibatalkan',
                'fill'    => 'bg-rose-500/10 text-rose-600 border-rose-500/20',
            ...
            default => [
                'label' => 'Pending',
                'fill'    => 'bg-amber-500/10 text-amber-600 border-amber-500/20',
